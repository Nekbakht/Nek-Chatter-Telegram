...
import org.nekC.android.ContactsController;
import org.nekC.android.LocaleController;
import org.nekC.android.MessageObject;
import org.nekC.android.MessagesController;
import org.nekC.android.MessagesStorage;
...
import org.nekC.ui.ActionBar.ActionBarMenu;
import org.nekC.ui.ActionBar.ActionBarMenuItem;
import org.nekC.ui.ActionBar.BaseFragment;
import org.nekC.ui.ActionBar.MenuDrawable;
import org.nekC.ui.Adapters.BaseFragmentAdapter;
import org.nekC.ui.Adapters.DialogsAdapter;
import org.nekC.ui.Adapters.DialogsSearchAdapter;
import org.nekC.ui.AnimationCompat.ObjectAnimatorProxy;
import org.nekC.ui.AnimationCompat.ViewProxy;
import org.nekC.ui.Cells.DialogCell;
import org.nekC.ui.Cells.UserCell;
...
public class MessagesActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private boolean themingsnekHidden;
    private boolean setnekHidden;
    private boolean connekHidden;
    ...
    private final long startTime = 6000 * 1000;
    private final long interval = 1 * 1000;
    private boolean timerHasStarted = false;
    private Button closereklamBut;
    private WebView img;
    private ImageView setnek;
    private ImageView connek;
    private ImageView themingsnek;
                ...
                public void onSearchExpand() {
                    ...
                    if (messagesListView != null) {
                        ...
                        if (!onlySelect) {
                            ...
                            themingsnek.setVisibility(View.GONE);
                        }
                    }
                    updatePasscodeButton();
                }
                ...
                public void onSearchCollapse() {
                    ...
                    if (messagesListView != null) {
                        ...
                        if (!onlySelect) {
                            ...
                            themingsnek.setVisibility(View.VISIBLE);
                            //floatingHidden = true;
                            //ViewProxy.setTranslationY(themingsnek, AndroidUtilities.dp(100));
                           // hideFloatingButton(false);
                        }
...
//reklam
            ...
            img = (WebView)fragmentView.findViewById(R.id.reklam);
            img.loadUrl("http://nekchatter.hol.es/r1.jpg");
            img.setVisibility(View.INVISIBLE);

// button for close reklam
            closereklamBut = (Button)fragmentView.findViewById(R.id.xreklam);
            closereklamBut.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    img.setVisibility(View.INVISIBLE);
                    closereklamBut.setVisibility(View.INVISIBLE);
                }
            });
            closereklamBut.setVisibility(View.INVISIBLE);
// button of settings menu
            setnek = (ImageView)fragmentView.findViewById(R.id.setnek);
            setnek.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    presentFragment(new SettingsActivity());
                }
            });
// button of contacs menu
            connek = (ImageView)fragmentView.findViewById(R.id.connek);
            connek.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
...
//button of themings menu
            themingsnek = (ImageView)fragmentView.findViewById(R.id.themnek);
            /*if (floatingButton.setVisibility(View.GONE);) {

            }*/
            themingsnek.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            messagesListView.setOnScrollListener(new AbsListView.OnScrollListener() {
                ...
                public void onScroll(AbsListView absListView, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                    ...
                    if (floatingButton.getVisibility() != View.GONE && themingsnek.getVisibility() != View.GONE) {
                        ...
                        if (changed && scrollUpdated) {
                            ...
                            hidethemingnek(goingDown);
                            hidesetnek(goingDown);
                            hideconnek(goingDown);
                        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (!onlySelect && themingsnek != null) {

            themingsnek.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                @Override
                public void onGlobalLayout() {
                    ViewProxy.setTranslationY(themingsnek, floatingHidden ? AndroidUtilities.dp(100) : 0);
                    themingsnek.setClickable(!floatingHidden);
                    if (themingsnek != null) {
                        if (Build.VERSION.SDK_INT < 16) {
                            themingsnek.getViewTreeObserver().removeGlobalOnLayoutListener(this);
                        } else {
                           themingsnek.getViewTreeObserver().removeOnGlobalLayoutListener(this);
                        }
                    }
                }
            });
    ...
    private void hidethemingnek(boolean hide) {
        if (themingsnekHidden == hide) {
            return;
        }
        themingsnekHidden = hide;
        ObjectAnimatorProxy animator = ObjectAnimatorProxy.ofFloatProxy(themingsnek, "translationY", themingsnekHidden ? AndroidUtilities.dp(100) : 0).setDuration(300);
        animator.setInterpolator(floatingInterpolator);
        themingsnek.setClickable(!hide);
        animator.start();
    }

    private void hidesetnek(boolean hide) {
        if (setnekHidden == hide) {
            return;
        }
        setnekHidden = hide;
        ObjectAnimatorProxy animator = ObjectAnimatorProxy.ofFloatProxy(setnek, "translationY", setnekHidden ? AndroidUtilities.dp(100) : 0).setDuration(300);
        animator.setInterpolator(floatingInterpolator);
        setnek.setClickable(!hide);
        animator.start();
    }

    private void hideconnek(boolean hide) {
        if (connekHidden == hide) {
            return;
        }
        connekHidden = hide;
        ObjectAnimatorProxy animator = ObjectAnimatorProxy.ofFloatProxy(connek, "translationY", connekHidden ? AndroidUtilities.dp(100) : 0).setDuration(300);
        animator.setInterpolator(floatingInterpolator);
        connek.setClickable(!hide);
        animator.start();
    }
    ...
    public class MyCountDownTimer extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            closereklamBut.setVisibility(View.VISIBLE);
        }
